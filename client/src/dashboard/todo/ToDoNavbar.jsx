        ...
        {TABS.map((tab) => {
          ...
          return (
            <Motion.button
              ...
              className={`flex min-w-[5rem] flex-1 items-center justify-center gap-2 whitespace-nowrap rounded-xl px-3 py-2.5 text-sm font-semibold transition-colors duration-200 ${
                isActive
