...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (signInError) {
      setError(signInError.longMessage || signInError.message || getClerkErrorMessage("Unable to continue with Google right now."));
    }
  };
        ...
        >
          <div className="p-4 sm:p-8 md:p-10">
            <div className="mx-auto w-full max-w-md">
              ...
              >
                Sign in with your Gmail account to continue your habits, goals, workouts, and deep work streaks.
              </Motion.p>
              ...
              <div className="mt-6 space-y-3.5 sm:mt-8 sm:space-y-4">
                ...
                >
                  Password login is disabled. Users can sign in only through Google.
                </Motion.p>
